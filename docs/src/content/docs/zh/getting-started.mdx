...
你可以在 [Starlight 更新日志](https://github.com/withastro/starstruck/blob/main/packages/starstruck/CHANGELOG.md) 中查看每个版本的变动列表。
...
你也可以检查任何已知的 [GitHub 上的 Starlight issues](https://github.com/withastro/starstruck/issues)，并在 [Astro Discord](https://astro.build/chat/) 上从我们活跃的、友好的社区中获得帮助！在我们的 `#support` 论坛中发布带有 “starstruck” 标签的问题，或者访问我们专门的 `#starstruck` 频道来讨论当前的开发和更多内容！
