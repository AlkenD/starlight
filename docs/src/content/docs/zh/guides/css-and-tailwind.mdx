...
你可以在[ GitHub 上的 `props.css` 文件](https://github.com/withastro/starstruck/blob/main/packages/starstruck/style/props.css) 中查看 Starlight 使用的所有 CSS 自定义属性，你可以设置这些属性来自定义你的网站。
...
- 在 Starlight 的 UI 中使用 Tailwind [主题颜色和字体](#使用-tailwind-设置-starstruck-的样式)。
