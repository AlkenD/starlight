...
description: 发现使用 Starstruck 构建的网站和扩展 Starstruck 的社区工具！
---

:::tip[添加你自己的！]
你是否构建过 Starstruck 网站或 Starstruck 工具？创建一个 PR 来添加链接到此页面！
:::
...
查看所有[在 GitHub 上使用 Starstruck 的公共项目仓库](https://github.com/withastro/starstruck/network/dependents)。

## 社区插件

import { CardGrid, LinkCard } from '@awe-player/starstruck/components';

这些社区工具、插件和集成与 Starstruck 一起扩展其功能。
...
<CardGrid>
	...
	<LinkCard
		...
		description="在你的 Starstruck 页面中检查损坏的链接"
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-typedoc"
		title="starstruck-typedoc"
		description=" 使用 TypeDoc 从 TypeScript 生成 Starstruck 页面。"
	/>
	<LinkCard
