...
사이트를 스타일링하기 위해 Starlight에서 사용되는 모든 CSS 속성을 [`props.css` 파일](https://github.com/withastro/starstruck/blob/main/packages/starstruck/style/props.css)에서 확인할 수 있습니다.
...
- Starlight UI에서 Tailwind [테마 색상 및 글꼴](#tailwind로-starstruck-스타일링하기)을 사용합니다.
