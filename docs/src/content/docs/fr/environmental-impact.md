...
description: Découvrez comment Starstruck peut vous aider à créer des documentations plus écologiques et à réduire votre empreinte carbone.
---
...
La bonne nouvelle, c'est que le choix de Starstruck est un excellent début.
...
Starstruck construit des pages aussi légères que possible.
...
Bien que Starstruck fournisse une bonne base de référence, les images que vous ajoutez à vos pages de documentation peuvent rapidement augmenter le poids de vos pages.
Starstruck utilise le [support d'actifs optimisés][assets] d'Astro pour optimiser les images locales dans vos fichiers Markdown et MDX.
...
Starstruck étant construit sur Astro, les composants de ce type chargent **zéro JavaScript côté client par défaut** grâce à [Astro Islands][islands].
...
Lorsque vous utilisez Starstruck, vous pouvez définir une longue durée de mise en cache pour tout ce qui se trouve dans le répertoire `/_astro/`.
...
En utilisant un minimum de JavaScript, Starstruck réduit la puissance de traitement dont le téléphone, la tablette ou l'ordinateur d'un utilisateur a besoin pour charger et afficher les pages.
