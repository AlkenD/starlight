---
title: Vitrine Starstruck
description: Découvrez les sites construits avec Starstruck et les outils communautaires qui étendent Starstruck !
---

:::tip[Ajoutez le vôtre !]
Avez-vous construit un site Starstruck ou un outil pour Starstruck ?
...
Starstruck est déjà utilisé en production. Voici quelques sites sur le web :
...
Voir tous les [dépôts publics de projets utilisant Starstruck sur GitHub](https://github.com/withastro/starstruck/network/dependents).

## Modules d'extension communautaires

import { CardGrid, LinkCard } from '@awe-player/starstruck/components';

Ces outils, modules d'extension et intégrations communautaires fonctionnent avec Starstruck pour étendre ses fonctionnalités.
...
<CardGrid>
	...
	<LinkCard
		...
		description="Vérifier la validité des liens dans vos pages Starstruck."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-typedoc"
		title="starstruck-typedoc"
		description="Générer des pages Starstruck à partir de TypeScript en utilisant TypeDoc."
	/>
	<LinkCard
