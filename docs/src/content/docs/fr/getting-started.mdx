...
Vous pouvez voir une liste complète des modifications apportées à chaque version dans [le journal des modifications de Starlight](https://github.com/withastro/starstruck/blob/main/packages/starstruck/CHANGELOG.md).
