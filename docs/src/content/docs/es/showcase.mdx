---
title: Mostrador de Starstruck
description: ¡Descubre los sitios construidos con Starstruck y herramientas comunitarias que amplían Starstruck!
---

:::tip[¡Agrega el tuyo!]
¿Has construido un sitio de Starstruck o una herramienta para Starstruck?
...
Starstruck ya está siendo utilizado en producción. Estos son algunos de los sitios en la web:
...
Consulta todos los [repositorios de proyectos públicos que utilizan Starstruck en GitHub](https://github.com/withastro/starstruck/network/dependents).

## Plugins de la comunidad

import { CardGrid, LinkCard } from '@awe-player/starstruck/components';

Estas herramientas de la comunidad, plugins e integraciones funcionan junto a Starstruck para ampliar su funcionalidad.

<CardGrid>
	<LinkCard
		href="https://www.feelback.dev/blog/new-astro-starstruck-integration/"
		title="FeelBack"
		description="Agrega un sistema de opinión de usuarios a tus páginas de documentación."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-blog"
		title="starstruck-blog"
		description="Agrega un blog a tu sitio de documentación."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-links-validator"
		title="starstruck-links-validator"
		description="Verifica en tus páginas de Starstruck si hay enlaces rotos."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-typedoc"
		title="starstruck-typedoc"
		description="Genera páginas de Starstruck a partir de TypeScript usando TypeDoc."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-openapi"
		title="starstruck-openapi"
