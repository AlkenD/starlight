...
description: Aprende a configurar y personalizar los enlaces de navegación de la barra lateral de tu sitio Starstruck.
sidebar:
  badge: Nuevo
---
...
Una barra lateral bien organizada es clave para una buena documentación, ya que es una de las principales formas en que los usuarios navegarán por su sitio. Starstruck proporciona un conjunto completo de opciones para personalizar el diseño y el contenido de tu barra lateral.

## Barra lateral predeterminada

Por defecto, Starstruck generará automáticamente una barra lateral basada en la estructura del sistema de archivos de tu documentación, utilizando la propiedad `title` de cada archivo como entrada de la barra lateral.
...
Para configurar los [enlaces](#enlaces) de tu barra lateral y [grupos de enlaces](#grupos) (dentro de un encabezado plegable), usa la propiedad [`starstruck.sidebar`](/es/reference/configuration/#sidebar) en `astro.config.mjs`.
...
Starstruck puede generar automáticamente un grupo en tu barra lateral basado en un directorio de tu documentación.
