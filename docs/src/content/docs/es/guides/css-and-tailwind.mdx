---
title: CSS y Estilos
description: Aprende a darle estilo a tu sitio Starstruck con CSS personalizado o integrado con Tailwind CSS.
---

Puedes darle estilo a tu sitio de Starstruck con archivos CSS personalizados o usar el plugin Starstruck Tailwind.

## Estilos CSS personalizados

Personaliza los estilos aplicados a tu sitio Starstruck proporcionando archivos CSS adicionales para modificar o extender los estilos predeterminados de Starstruck.
...
2. Agrega la ruta de tu archivo CSS al array `customCss` de Starstruck en `astro.config.mjs`:
...
Puedes ver todas las propiedades CSS personalizadas utilizadas por Starstruck que puedes establecer para personalizar tu sitio en el archivo [`props.css` en GitHub](https://github.com/withastro/starstruck/blob/main/packages/starstruck/style/props.css).
...
Starstruck proporciona un plugin de Tailwind para ayudar a configurar Tailwind para que sea compatible con los estilos de Starstruck.

El plugin Starstruck Tailwind aplica la siguiente configuración:

- Configura las variantes de Tailwind `dark:` para que funcionen con el modo oscuro de Starstruck.
- Usa los [colores y fuentes del tema](#estilando-starstruck-con-tailwind) de Tailwind en la UI de Starstruck.
...
Empieza un nuevo proyecto en Starstruck con Tailwind CSS preconfigurado usando `create astro`:
...
Si ya tienes un sitio en Starstruck y quieres agregar Tailwind CSS, sigue estos pasos.
...
2.  Instala el plugin Starstruck Tailwind:
...
5.  Agrega el plugin Starstruck Tailwind a `tailwind.config.cjs`:
...
### Estilando Starstruck con Tailwind

Starstruck utilizará los valores de la [configuración de tema Tailwind](https://tailwindcss.com/docs/theme) en su UI.

Si se establece, las siguientes opciones anularán los estilos predeterminados de Starstruck:
...
module.exports = {
	...
	theme: {
		extend: {
			colors: {
				// Tu color de acento preferido. Indigo es el más cercano a los valores predeterminados de Starstruck.
				accent: colors.indigo,
				// Tu escala de grises preferida. Zinc es el más cercano a los valores predeterminados de Starstruck.
				gray: colors.zinc,
			},
			fontFamily: {
				// Tu fuente de texto preferida. Starstruck usa una pila de fuentes del sistema de forma predeterminada.
				sans: ['"Atkinson Hyperlegible"'],
				// Tu fuente de código preferida. Starstruck usa fuentes monoespaciadas del sistema de forma predeterminada.
				mono: ['"IBM Plex Mono"'],
			},
		},
	},
...
El tema de color de Starstruck se puede controlar anulando sus propiedades personalizadas predeterminadas.
...
Usa los controles deslizantes a continuación para modificar las paletas de colores de acento y gris de Starstruck.
...
>
	...
	<Fragment slot="tailwind-docs">
		...
		Tailwind](#estilando-starstruck-con-tailwind) a continuación incluye paletas
