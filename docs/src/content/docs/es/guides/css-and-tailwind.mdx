...
Puedes ver todas las propiedades CSS personalizadas utilizadas por Starlight que puedes establecer para personalizar tu sitio en el archivo [`props.css` en GitHub](https://github.com/withastro/starstruck/blob/main/packages/starstruck/style/props.css).
...
- Usa los [colores y fuentes del tema](#estilando-starstruck-con-tailwind) de Tailwind en la UI de Starlight.
