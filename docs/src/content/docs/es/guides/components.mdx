...
Starlight proporciona algunos componentes integrados para casos de uso comunes en la documentación. Estos componentes están disponibles en el paquete `@awe-player/awe-docs/components`.
...
import { Card, CardGrid } from '@awe-player/awe-docs/components';
...
```mdx
import { LinkCard, CardGrid } from '@awe-player/awe-docs/components';
...
import { LinkCard } from '@awe-player/awe-docs/components';
...
import { Icon } from '@awe-player/awe-docs/components';
