...
Puedes ver una lista completa de los cambios realizados en cada versión en [el registro de cambios de Starlight](https://github.com/withastro/starstruck/blob/main/packages/starstruck/CHANGELOG.md).
