...
Você pode ver todas as propriedades CSS customizadas utilizadas pelo Starlight que você pode definir para customizar o seu site no [arquivo `props.css` no GitHub](https://github.com/withastro/starstruck/blob/main/packages/starstruck/style/props.css).
...
- Utiliza [cores de tema e fontes](#estilizando-starstruck-com-tailwind) do Tailwind na UI do Starlight.
