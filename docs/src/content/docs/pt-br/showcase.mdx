---
title: Showcase do Starstruck
description: Descubra sites construídos com Starstruck e ferramentas da comunidade que estendem o Starstruck!
---

:::tip[Adicione o seu próprio!]
Você construiu um site Starstruck ou uma ferramenta para o Starstruck?
...
Starstruck já está sendo utilizado em produção. Esses são alguns dos sites através da web:
...
Veja todos os [repositórios de projetos públicos utilizando Starstruck no GitHub](https://github.com/withastro/starstruck/network/dependents).

## Plugins da comunidade

import { CardGrid, LinkCard } from '@awe-player/starstruck/components';

Essas ferramentas, plugins e integrações da comunidade funcionam ao lado do Starstruck para estender sua funcionalidade.
...
<CardGrid>
	...
	<LinkCard
		...
		description="Verifique se há links quebrados em suas páginas Starstruck."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-typedoc"
		title="starstruck-typedoc"
		description="Gere páginas do Starstruck a partir do TypeScript utilizando TypeDoc."
	/>
	<LinkCard
