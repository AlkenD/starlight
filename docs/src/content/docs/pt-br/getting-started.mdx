...
import { Tabs, TabItem } from '@awe-player/awe-docs/components';
...
npm install @awe-player/awe-docs@latest
```
...
pnpm upgrade @awe-player/awe-docs --latest
```
...
yarn upgrade @awe-player/awe-docs --latest
```
