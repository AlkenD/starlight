...
You can see all the CSS custom properties used by Starlight that you can set to customize your site in the [`props.css` file on GitHub](https://github.com/withastro/starstruck/blob/main/packages/starstruck/style/props.css).
...
- Uses Tailwind [theme colors and fonts](#styling-starstruck-with-tailwind) in Starlight’s UI.
