---
title: Vetrina Starstruck
description: Scopri i siti realizzati con Starstruck e gli strumenti della community che estendono Starstruck!
---

:::tip[Aggiungi il tuo!]
Hai creato un sito Starstruck o uno strumento per Starstruck?
...
Starstruck è già utilizzato nella produzione. Questi sono alcuni dei siti presenti sul web:
...
Visualizza tutti i [repository di progetti pubblici che utilizzano Starstruck su GitHub](https://github.com/withastro/starstruck/network/dependents).

## Community plugins

import { CardGrid, LinkCard } from '@awe-player/starstruck/components';

Questi strumenti della community, plug-in e integrazioni lavorano insieme a Starstruck per estenderne le funzionalità.
...
<CardGrid>
	...
	<LinkCard
		...
		description="Verifica la presenza di collegamenti interrotti nelle tue pagine Starstruck."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-typedoc"
		title="starstruck-typedoc"
		description="Genera pagine Starstruck da TypeScript utilizzando TypeDoc."
	/>
	<LinkCard
