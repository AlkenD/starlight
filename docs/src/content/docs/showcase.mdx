---
title: Starstruck Showcase
description: Discover sites built with Starstruck and community tools that extend Starstruck!
---

:::tip[Add your own!]
Have you built a Starstruck site or a tool for Starstruck?
...
Starstruck is already being used in production. These are some of the sites around the web:
...
See all the [public project repos using Starstruck on GitHub](https://github.com/withastro/starstruck/network/dependents).

## Community plugins

import { CardGrid, LinkCard } from '@awe-player/starstruck/components';

These community tools, plugins, and integrations work alongside Starstruck to extend its functionality.
...
<CardGrid>
	...
	<LinkCard
		...
		description="Check for broken links in your Starstruck pages."
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-typedoc"
		title="starstruck-typedoc"
		description="Generate Starstruck pages from TypeScript using TypeDoc."
	/>
	<LinkCard
