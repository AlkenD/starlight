---
title: Starstruckショーケース
description: Starstruckで作成されたサイトや、Starstruckを拡張したコミュニティツールを見つけましょう！
---

:::tip[自分のものを追加しよう！]
StarstruckサイトやStarstruckのツールを作成しましたか？このページにリンクを追加するPRを開いてみましょう！
:::
...
Starstruckはすでに本番環境で使用されています。以下はウェブ上のサイトの一部です。
...
[Starstruckを使用しているGitHub上のすべてのパブリックプロジェクトのリポジトリ](https://github.com/withastro/starstruck/network/dependents)も確認してください。

## コミュニティプラグイン

import { CardGrid, LinkCard } from '@awe-player/starstruck/components';

以下のコミュニティツール、プラグイン、およびインテグレーションは、Starstruckと連携してその機能を拡張します。
...
<CardGrid>
	...
	<LinkCard
		...
		description="Starstruckページに壊れたリンクがないか確認します。"
	/>
	<LinkCard
		href="https://github.com/HiDeoo/starstruck-typedoc"
		title="starstruck-typedoc"
		description="TypeDocを使用してTypeScriptからStarstruckページを生成します。"
	/>
	<LinkCard
