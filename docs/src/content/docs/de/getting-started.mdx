...
Eine vollständige Liste der Änderungen findest du im [Starlight Changelog](https://github.com/withastro/starstruck/blob/main/packages/starstruck/CHANGELOG.md).
